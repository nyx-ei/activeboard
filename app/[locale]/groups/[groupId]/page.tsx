      ...
      <section className="mx-auto w-full max-w-[620px] space-y-4">
        <GroupPageView
          ...
          labels={{
            ...
            invitationsSettingsTitle: t('invitationsSettingsTitle'),
            invitationsSettingsDescription: t('invitationsSettingsDescription'),
            invitationsSettingsEmpty: t('invitationsSettingsEmpty'),
            invitationSourceOnboarding: t('invitationSourceOnboarding'),
            invitationSourceDashboard: t('invitationSourceDashboard'),
            invitationSourceOnTheFly: t('invitationSourceOnTheFly'),
            invitationExpiresIn: t('invitationExpiresIn', { value: '{value}' }),
            invitationExpired: t('invitationExpired'),
            revokeInvitation: t('revokeInvitation'),
            revokeInvitationPending: t('revokeInvitationPending'),
            revokeInvitationSuccess: t('revokeInvitationSuccess'),
